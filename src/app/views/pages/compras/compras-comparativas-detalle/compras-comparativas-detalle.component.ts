...
let g_router;
@Component({
  selector: 'kt-compras-comparativas-detalle',
  templateUrl: './compras-comparativas-detalle.component.html',
  styleUrls: ['./compras-comparativas-detalle.component.scss']
})
export class ComprasComparativasDetalleComponent implements OnInit {
