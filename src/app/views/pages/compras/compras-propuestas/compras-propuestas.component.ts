...
let g_router;
@Component({
  selector: 'kt-compras-propuestas',
  templateUrl: './compras-propuestas.component.html',
  styleUrls: ['./compras-propuestas.component.scss']
})
export class ComprasPropuestasComponent implements OnInit {
...
function initEvents6() {
	$('#nuevo-prov').on('click', 'a.btn-icon-sm', function () {
