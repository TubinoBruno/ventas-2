...
@Component({
  selector: 'kt-contrato-adenda',
  templateUrl: './contrato-adenda.component.html',
  styleUrls: ['./contrato-adenda.component.scss']
})
export class ContratoAdendaComponent implements OnInit {
...
function initEvents3() {
	$('#menu-contrato').on('click', 'a.contrato-detalle', function () {
