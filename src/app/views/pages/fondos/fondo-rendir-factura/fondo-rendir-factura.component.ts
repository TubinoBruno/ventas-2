...
let g_router;
@Component({
  selector: 'kt-fondo-rendir-factura',
  templateUrl: './fondo-rendir-factura.component.html',
  styleUrls: ['./fondo-rendir-factura.component.scss']
})
export class FondoRendirFacturaComponent implements OnInit {
