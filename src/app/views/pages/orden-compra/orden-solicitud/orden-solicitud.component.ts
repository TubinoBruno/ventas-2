...
let g_router;
@Component({
  selector: 'kt-orden-solicitud',
  templateUrl: './orden-solicitud.component.html',
  styleUrls: ['./orden-solicitud.component.scss']
})
export class OrdenSolicitudComponent implements OnInit {
