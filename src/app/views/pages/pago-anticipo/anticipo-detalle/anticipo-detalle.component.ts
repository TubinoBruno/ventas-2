...
let g_router;
@Component({
  selector: 'kt-anticipo-detalle',
  templateUrl: './anticipo-detalle.component.html',
  styleUrls: ['./anticipo-detalle.component.scss']
})
export class AnticipoDetalleComponent implements OnInit {
