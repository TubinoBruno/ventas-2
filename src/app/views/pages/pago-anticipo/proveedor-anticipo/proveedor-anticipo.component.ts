...
let g_router;
@Component({
  selector: 'kt-proveedor-anticipo',
  templateUrl: './proveedor-anticipo.component.html',
  styleUrls: ['./proveedor-anticipo.component.scss']
})
export class ProveedorAnticipoComponent implements OnInit {
...
function initEvents3() {
	$('#menu-ant').on('click', 'a.rendicion', function () {
		g_router.navigate(['/admin/pago-anticipo/rendicion']);
	});
}
function initEvents4() {
	$('#menu-ant').on('click', 'a.anticipo', function () {
		g_router.navigate(['/admin/pago-anticipo/anticipo']);
	});
}