...
let g_router;
@Component({
  selector: 'kt-asignacion-bancaria-detalle',
  templateUrl: './asignacion-bancaria-detalle.component.html',
  styleUrls: ['./asignacion-bancaria-detalle.component.scss']
})
export class AsignacionBancariaDetalleComponent implements OnInit {
