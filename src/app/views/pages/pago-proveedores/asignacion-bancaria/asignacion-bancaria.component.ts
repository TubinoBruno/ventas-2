...
let g_router;
@Component({
  selector: 'kt-asignacion-bancaria',
  templateUrl: './asignacion-bancaria.component.html',
  styleUrls: ['./asignacion-bancaria.component.scss']
})
export class AsignacionBancariaComponent implements OnInit {
...
function initEvents4() {
	$('#menu-ocp').on('click', 'a.proveedor-factura', function () {
