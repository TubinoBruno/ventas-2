...
let g_router;
@Component({
  selector: 'kt-cheque-detalle',
  templateUrl: './cheque-detalle.component.html',
  styleUrls: ['./cheque-detalle.component.scss']
})
export class ChequeDetalleComponent implements OnInit {
