...
let g_router;
@Component({
  selector: 'kt-cuenta-pagar-detalle',
  templateUrl: './cuenta-pagar-detalle.component.html',
  styleUrls: ['./cuenta-pagar-detalle.component.scss']
})
export class CuentaPagarDetalleComponent implements OnInit {
