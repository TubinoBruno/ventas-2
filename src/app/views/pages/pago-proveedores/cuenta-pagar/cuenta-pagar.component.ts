...
let g_router;
@Component({
  selector: 'kt-cuenta-pagar',
  templateUrl: './cuenta-pagar.component.html',
  styleUrls: ['./cuenta-pagar.component.scss']
})
export class CuentaPagarComponent implements OnInit {
