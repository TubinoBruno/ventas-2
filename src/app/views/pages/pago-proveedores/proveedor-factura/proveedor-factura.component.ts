...
let g_router;
@Component({
  selector: 'kt-proveedor-factura',
  templateUrl: './proveedor-factura.component.html',
  styleUrls: ['./proveedor-factura.component.scss']
})
export class ProveedorFacturaComponent implements OnInit {
...
function initEvents2() {
	$('#menu-ocp').on('click', 'a.solicitud-pago', function () {
		g_router.navigate(['/admin/pago-proveedor/solicitud-pago']);
	});
}
function initEvents3() {
	$('#menu-ocp').on('click', 'a.cuenta-pagar', function () {
		g_router.navigate(['/admin/pago-proveedor/cuenta-pagar']);
	});
}
function initEvents4() {
	$('#menu-ocp').on('click', 'a.asignacion-bancaria', function () {
		g_router.navigate(['/admin/pago-proveedor/asignacion-bancaria']);
	});
}
function initEvents5() {
	$('#menu-ocp').on('click', 'a.transferencia', function () {
		g_router.navigate(['/admin/pago-proveedor/transferencia']);
	});
}
function initEvents1() {
	$('#menu-ocp').on('click', 'a.cheque', function () {
		g_router.navigate(['/admin/pago-proveedor/cheque']);
	});
}
