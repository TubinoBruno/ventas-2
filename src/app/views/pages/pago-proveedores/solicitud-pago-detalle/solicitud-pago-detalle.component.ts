...
let g_router;
@Component({
  selector: 'kt-solicitud-pago-detalle',
  templateUrl: './solicitud-pago-detalle.component.html',
  styleUrls: ['./solicitud-pago-detalle.component.scss']
})
export class SolicitudPagoDetalleComponent implements OnInit {
