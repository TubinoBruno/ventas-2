...
let g_router;
@Component({
  selector: 'kt-comprobante-egreso-detalle',
  templateUrl: './comprobante-egreso-detalle.component.html',
  styleUrls: ['./comprobante-egreso-detalle.component.scss']
})
export class ComprobanteEgresoDetalleComponent implements OnInit {
