...
let g_router;
@Component({
  selector: 'kt-comprobante-pagar',
  templateUrl: './comprobante-pagar.component.html',
  styleUrls: ['./comprobante-pagar.component.scss']
})
export class ComprobantePagarComponent implements OnInit {
...
function initEvents1() {
	$('#menu-s').on('click', 'a.solicitud', function () {
		g_router.navigate(['/admin/pago-servicio-lista/solicitud']);
	});
}
function initEvents2() {
	$('#menu-s').on('click', 'a.comprobante-egreso', function () {
		g_router.navigate(['/admin/pago-servicio-lista/comprobante-egreso']);
	});
}
function initEvents() {
	$('#menu-s').on('click', 'a.comprobante-pagar', function () {
		g_router.navigate(['/admin/pago-servicio-lista/comprobante-pagar']);
	});
}
