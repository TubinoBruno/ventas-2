...
let g_router;
@Component({
  selector: 'kt-pedidos-almacen-items',
  templateUrl: './pedidos-almacen-items.component.html',
  styleUrls: ['./pedidos-almacen-items.component.scss']
})
export class PedidosAlmacenItemsComponent implements OnInit {
...
function initEvents() {
	$('#menu-pedidos').on('click', 'a.datos-generales', function () {
