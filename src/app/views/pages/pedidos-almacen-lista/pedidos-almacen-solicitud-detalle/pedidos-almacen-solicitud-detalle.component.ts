...
let g_router;
@Component({
  selector: 'kt-pedidos-almacen-solicitud-detalle',
  templateUrl: './pedidos-almacen-solicitud-detalle.component.html',
  styleUrls: ['./pedidos-almacen-solicitud-detalle.component.scss']
})
export class PedidosAlmacenSolicitudDetalleComponent implements OnInit {
...
function initEvents() {
	$('#pedidos-menu').on('click', 'a.items-pedido', function () {
		g_router.navigate(['/admin/pedido-almacen/pedidos-almacen-items-detalle']);
	});
}