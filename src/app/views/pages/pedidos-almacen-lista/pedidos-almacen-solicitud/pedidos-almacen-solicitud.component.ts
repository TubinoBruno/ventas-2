...
let g_router;
@Component({
  selector: 'kt-pedidos-almacen-solicitud',
  templateUrl: './pedidos-almacen-solicitud.component.html',
  styleUrls: ['./pedidos-almacen-solicitud.component.scss']
})
export class PedidosAlmacenSolicitudComponent implements OnInit {
...
function initEvents() {
	$('#menu-pedidos').on('click', 'a.items-pedido', function () {
		g_router.navigate(['/admin/pedido-almacen/pedidos-almacen-items']);
	});
}